	...
	// that have the least amount of possible choices
{
	...
	for (int i = MinValue; i <= MaxValue; i++)
	{
		for (int j = MinValue; j <= MaxValue; j++)
		{
			...
			//using this for loop to find the blank with the least conflicts reduces the number of recursive calls but increases the time to finish solving the board.
